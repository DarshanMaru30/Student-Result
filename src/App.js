    ...
    <div>
      ...
      <div className='InputDtl'>
        <div>
          ...
          <input type='text' placeholder='Enter Name' onChange={e => setResValue({ ...resValue, name: e.target.value })} >
          </input>
        </div>
        <div>
          {[1, 2, 3, 4, 5].map(ele => (
            <div key={ele}>
              ...
              <input type='text' placeholder='0' onChange={e => handleInputChange(`sub${ele}`, e.target.value)}
              />
            </div>
          ))}
        </div>
